...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Override.ref_id'
        db.delete_column(u'raw_override', 'ref_id')

        # Adding field 'Override.ref_uid'
        db.add_column(u'raw_override', 'ref_uid',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Override.ref_id'
        raise RuntimeError("Cannot reverse this migration. 'Override.ref_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Override.ref_id'
        db.add_column(u'raw_override', 'ref_id',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'Override.ref_uid'
        db.delete_column(u'raw_override', 'ref_uid')
