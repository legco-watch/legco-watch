...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RawCouncilQuestion.raised_by'
        db.delete_column(u'raw_rawcouncilquestion', 'raised_by')
    ...
    def backwards(self, orm):
        # Adding field 'RawCouncilQuestion.raised_by'
        db.add_column(u'raw_rawcouncilquestion', 'raised_by',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'raw.rawcouncilquestion': {
            ...
            'asker': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'crawled_from': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'last_crawled': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
