...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RawCouncilQuestion.asker'
        db.delete_column(u'raw_rawcouncilquestion', 'asker')

        # Adding field 'RawCouncilQuestion.raw_asker'
        db.add_column(u'raw_rawcouncilquestion', 'raw_asker',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'RawCouncilQuestion.reply_link'
        db.alter_column(u'raw_rawcouncilquestion', 'reply_link', self.gf('django.db.models.fields.TextField')())

        # Changing field 'RawCouncilQuestion.subject_link'
        db.alter_column(u'raw_rawcouncilquestion', 'subject_link', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'RawCouncilQuestion.asker'
        db.add_column(u'raw_rawcouncilquestion', 'asker',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'RawCouncilQuestion.raw_asker'
        db.delete_column(u'raw_rawcouncilquestion', 'raw_asker')


        # Changing field 'RawCouncilQuestion.reply_link'
        db.alter_column(u'raw_rawcouncilquestion', 'reply_link', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'RawCouncilQuestion.subject_link'
        db.alter_column(u'raw_rawcouncilquestion', 'subject_link', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'raw.rawmeeting': {
            ...
            'committees': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'meetings'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['raw.RawCommittee']"}),
            'crawled_from': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_crawled': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_parsed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
