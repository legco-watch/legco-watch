...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'raw_rawcouncilquestion', 'asker',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['raw.RawMember'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RawCouncilQuestion.asker'
        db.delete_column(u'raw_rawcouncilquestion', 'asker_id')
    ...
    models = {
        ...
        u'raw.rawcouncilquestion': {
            ...
            'asker': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['raw.RawMember']", 'null': 'True', 'blank': 'True'}),
            'crawled_from': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'last_crawled': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
