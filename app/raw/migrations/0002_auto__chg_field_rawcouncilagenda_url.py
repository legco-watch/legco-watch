...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawCouncilAgenda.url'
        db.alter_column(u'raw_rawcouncilagenda', 'url', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'RawCouncilAgenda.url'
        db.alter_column(u'raw_rawcouncilagenda', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
