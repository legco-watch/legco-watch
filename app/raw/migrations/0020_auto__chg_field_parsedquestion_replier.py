...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParsedQuestion.replier'
        db.alter_column(u'raw_parsedquestion', 'replier', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ParsedQuestion.replier'
        db.alter_column(u'raw_parsedquestion', 'replier', self.gf('django.db.models.fields.CharField')(max_length=255))
