...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParsedPerson.education_e'
        db.add_column(u'raw_parsedperson', 'education_e',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ParsedPerson.education_c'
        db.add_column(u'raw_parsedperson', 'education_c',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ParsedPerson.occupation_e'
        db.add_column(u'raw_parsedperson', 'occupation_e',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ParsedPerson.occupation_c'
        db.add_column(u'raw_parsedperson', 'occupation_c',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParsedPerson.education_e'
        db.delete_column(u'raw_parsedperson', 'education_e')

        # Deleting field 'ParsedPerson.education_c'
        db.delete_column(u'raw_parsedperson', 'education_c')

        # Deleting field 'ParsedPerson.occupation_e'
        db.delete_column(u'raw_parsedperson', 'occupation_e')

        # Deleting field 'ParsedPerson.occupation_c'
        db.delete_column(u'raw_parsedperson', 'occupation_c')
